...
var _receiveSearchGiphys = __webpack_require__(217);
...
document.addEventListener("DOMContentLoaded", function () {
  window.store = store;
  window.receiveSearchGiphys = _receiveSearchGiphys.receiveSearchGiphys;
...
var receiveSearchGiphys = exports.receiveSearchGiphys = function receiveSearchGiphys(giphys) {
  return { type: RECEIVE_SEARCH_GIPHYS, giphys: giphys };
};
